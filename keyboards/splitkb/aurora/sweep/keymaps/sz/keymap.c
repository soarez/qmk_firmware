...
[2] = LAYOUT(
    KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , XXXXXXX , KC_LPRN , KC_RPRN , KC_UNDS , KC_BSPC ,
    KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , XXXXXXX , KC_LCBR , KC_RCBR , KC_PIPE , KC_BSLS ,
    KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , XXXXXXX , KC_LBRC , KC_RBRC , KC_DQUO , KC_QUOT ,
                                  XXXXXXX , XXXXXXX , KC_NO   , MO(8)
),
[3] = LAYOUT(
    RGB_M_T , RGB_M_P , KC_UP   , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,
    RGB_TOG , KC_LEFT , KC_DOWN , KC_RGHT , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,
...
[5] = LAYOUT(
    ...
    XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , QK_MAKE , KC_F6  , KC_7   , KC_8   , KC_9    , KC_F10  ,
